...
class ChatHistory:
    ...
    def default_greeting(self):
        return "Hi 👋, I am Hexacare an AI based NLP bot? "

    def default_prompt(self, topic):
        return "I know all about the company that exists to create smiles, How can I help you? 🤗"
            ...
            with container:
                for i in range(len(st.session_state["assistant"])):
                    message(
                        ...
                        avatar_style="Initials", seed ="Hexaware"}",
                    )
